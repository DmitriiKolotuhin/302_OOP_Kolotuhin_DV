...
class StudentsListTest extends TestCase
{
    public function testCurrentAndNext(): void
    {
        ...
        $studentFirst->setLast('Красулин')->setFirst('НикитаУборщик')->setCourse('3')->setGroup('302');

        $studentSecond = new Student();
        $studentSecond->setLast('Распутин')->setFirst('Григорий')->setCourse('2')->setGroup('205');

        $studentThird = new Student();
        $studentThird->setLast('Николай')->setFirst('Романович')->setCourse('1')->setGroup('102');
